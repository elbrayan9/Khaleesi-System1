...
export const getAllDataForUser = async (userId, collectionName) => {
  ...
  try {
    ...
    console.error(
      `Error obteniendo datos de ${collectionName} para ${userId}: `,
      error,
    );
    return [];
  }
...
export const addProducto = (userId, productoData) =>
  addDocument(userId, 'productos', productoData);
...
export const addCliente = (userId, clienteData) =>
  addDocument(userId, 'clientes', clienteData);
...
// --- VENDEDORES ---
export const getVendedores = (userId) =>
  getAllDataForUser(userId, 'vendedores');
export const addVendedor = (userId, vendedorData) =>
  addDocument(userId, 'vendedores', vendedorData);
...
export const addEgreso = (userId, egresoData) =>
  addDocument(userId, 'egresos', egresoData);
export const deleteEgreso = (docId) => deleteDocument('egresos', docId);
export const getIngresosManuales = (userId) =>
  getAllDataForUser(userId, 'ingresos_manuales');
export const addIngresoManual = (userId, ingresoData) =>
  addDocument(userId, 'ingresos_manuales', ingresoData);
...
export const addNotaCDSimple = (userId, notaData) =>
  addDocument(userId, 'notas_cd', notaData);
