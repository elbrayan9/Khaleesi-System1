...
function PaymentModal({ isOpen, onClose, total, cliente, onConfirm, formatCurrency }) {
    ...
    return (
        ...
        <div className="fixed inset-0 bg-black bg-opacity-75 flex items-center justify-center p-4 z-50">
            {/* Contenedor del modal zinc oscuro */}
