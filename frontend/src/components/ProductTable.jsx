    ...
    <Table>
      <TableHeader>
        <TableRow className="border-b-zinc-700 hover:bg-transparent">
          ...
          <TableHead className="hidden 2xl:table-cell">Cód. Barras</TableHead>
          ...
          <TableHead className="hidden 2xl:table-cell">Categoría</TableHead>
        ...
        {products.length === 0 ? (
          ...
          products.map((p) => (
            ...
            >
              ...
              <TableCell className="hidden font-mono text-zinc-400 2xl:table-cell">
                {p.codigoBarras || 'N/A'}
              </TableCell>
              ...
              <TableCell className="hidden text-zinc-400 2xl:table-cell">
                {p.categoria || 'N/A'}
              </TableCell>
