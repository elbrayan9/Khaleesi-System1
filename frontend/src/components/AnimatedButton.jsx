      ...
      >
        ...
        {!hideAnimations && (
          <div className="absolute inset-0 -z-30 overflow-visible blur-[2px] [container-type:size]">
            <div className="animate-shimmer-slide-scoped absolute inset-0 h-[100cqh] [aspect-ratio:1]">
              <div className="animate-spin-around-scoped absolute -inset-full w-auto rotate-0 [background:conic-gradient(from_calc(270deg-(var(--spread)*0.5)),transparent_0,var(--shimmer-color)_var(--spread),transparent_var(--spread))]" />
            </div>
          </div>
        )}
