...
const GlitchText = ({
  ...
  const baseClasses =
    "font-black relative mx-auto select-none cursor-pointer"; // Quitamos tamaño y color base, se definen al usar el componente
  ...
  return (
    ...
    <div style={inlineStyles} data-text={typeof children === 'string' ? children : ''} className={combinedClasses}>
